...
@if(isset($myData))
    <div class="clearfix">
        <div class="pl4 pt3" style="width:1440px;">
        @foreach ($myData as $data)
            <div class="col col-12 md-col-4 px1" style="width: 400px;">
                <div class="pl2 pr2" style="position:relative;height:300px; width: 400px; overflow:hidden">
                    <img src="{{$data->puff_url}}" width="{{$data->puff_width}}" height="{{$data->puff_height}}">
